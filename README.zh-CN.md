...
- Electron 桌面版: [vue3-electron-vite](https://github.com/diorlitao/vue3-electron-vite)
...
[中文文档](https://github.com/diorlitao/vue3-admin-vite)
...
| 位置         | 账号            | 链接                                                |
| ------------ | --------------- | --------------------------------------------------- |
| github-pages | admin 或 editor | [链接](https://diorlitao.github.io/vue3-admin-vite) |
