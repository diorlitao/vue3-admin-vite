...
.hideSidebar {
  .main-container {
    margin-left: var(--ui-sidebar-hide-width);
  }
  .sidebar-container {
    width: var(--ui-sidebar-hide-width) !important;
  }
  .fixed-header {
    width: calc(100% - var(--ui-sidebar-hide-width));
  }
}
...
.mobile {
  ...
  &.hideSidebar {
    .sidebar-container {
      ...
      transform: translate3d(calc(0px - var(--ui-sidebar-width)), 0, 0);
    }
  }
