  ...
  <div class="navigation-bar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="right-menu-item">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <a target="_blank" href="https://github.com/diorlitao/vue3-admin-vite">
              <el-dropdown-item>中文文档</el-dropdown-item>
            </a>
            <a target="_blank" href="https://github.com/diorlitao/vue3-admin-vite">
              <el-dropdown-item>GitHub</el-dropdown-item>
            </a>
            <a target="_blank" href="https://gitee.com/diorlitao/vue3-admin-vite">
...
.navigation-bar {
  height: var(--ui-navigationbar-height);
  overflow: hidden;
  background: #fff;
  .hamburger {
    display: flex;
